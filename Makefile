...
.PHONY: khednes
khednes: main.o rom.o mem.o cpu2.o ppu3.o util.o apu.o compositor.o mapper.o mapper_001_mmc1.o mapper_002_unrom.o mapper_003_cnrom.o mapper_011_color_dreams.o
...
.PHONY: debug
debug: main.odb rom.odb mem.odb cpu2.odb ppu3.odb util.odb apu.odb compositor.odb mapper.odb mapper_001_mmc1.odb mapper_002_unrom.odb mapper_003_cnrom.odb mapper_011_color_dreams.odb
